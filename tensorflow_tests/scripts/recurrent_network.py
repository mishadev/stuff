...
trainset_provider = TwetterDataProvider(amount=0.001)
trainset_provider.fetch_data()

testset_provider = TwetterDataProvider(words_list=trainset_provider.words_list, train=False, amount=0.001)
